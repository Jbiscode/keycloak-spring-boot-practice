...
**Tests**: Executable verification is REQUIRED for every user story. Automated test
tasks SHOULD be included whenever the spec or plan can reasonably support them.
...
- [ ] T012 [US1] Add executable verification commands for this story to quickstart/spec docs
...
- [ ] T021 [US2] Add executable verification commands for this story to quickstart/spec docs
...
- [ ] T028 [US3] Add executable verification commands for this story to quickstart/spec docs
...
- [ ] TXXX Verify Docker Compose and learner runbook still match committed config
...
- Story verification commands MUST exist before the story is marked complete
...
- Each user story must include exact verification commands the learner can run
